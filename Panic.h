...
void logExprVerboseHelper(const char *func, const char *file, const int line, const char * format, const char *exprs,...)
{
    fprintf(stderr, "Log -\n");
    fprintf(stderr, "\tFile: %s\n", file);
    fprintf(stderr, "\tLine: %i\n", line);
...
#define logExprVerbose(format, ...)  logExprHelper(__func__, __FILE__, __LINE__, format, #__VA_ARGS__, __VA_ARGS__)
